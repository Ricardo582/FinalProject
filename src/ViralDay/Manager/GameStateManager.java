...
public class GameStateManager {
    ...
    private double volSFX = 1.0;
    private double volMusic = 1.0;
    ...
    public double getVolSFX() {
        return volSFX;
    }
    
    public void setVolSFX(double volume) {
        this.volSFX = volume;
    }
    
    public double getVolMusic() {
        return volMusic;
    }
    
    public void setVolMusic(double volume) {
